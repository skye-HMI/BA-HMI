...
The controllers described above were tested within the experimental design notified in \ref{sec:experimental design}. If not mentioned explicitly, the shown trajectories are designed using cubic splines and centripetal parametrization. 
