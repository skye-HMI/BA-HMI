...
\begin{figure}[h]
    \centering
    \includegraphics[width = 0.6\textwidth]{graphics/constantTimeScaling_adoptedBoundaries.eps}
    \caption{Visualisation of the linear time scaling with adopted boundaries.}
