...
Taking existing solution brings with it, that these solutions also have to be understood thoroughly. Otherwise it is impossible to adopt it reasonably. E.g. the source Code of \textsc{QGroundControl} had to be analyzed and this proved to be not that easy as it was someone else's code. However, as time passes by, you get used to it.\\
