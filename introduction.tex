...
The HMI (or control device) for a machine mainly depends on its number of control inputs and its level of automation. To control more control inputs, additional sticks or similar devices have to be provided. Automation of the system can simplify its control, but necessitates emergency backups in case of automation fail. \\
